...
Build the landing page as above, then build both tool pages:

```sh
python3 site/theme/build.py --config site/deep-research.json --output _site/deep-research
python3 site/theme/build.py --config site/fact-check.json --output _site/fact-check
```
